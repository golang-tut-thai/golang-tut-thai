...
เนื่องจาก golang นั้นมีสามารถ assign ค่าให้ตัวแปรได้หลายค่า เพราะฉะนั้น function ก็สามารถ 
...
จาก code ข้างต้น เมื่อเรียก `Mysquare(2.5)` จะได้ค่ากลับมาสองค่า เพราะฉะนั้นจะต้องนำตัวแปรมารับสองค่าเช่นกัน แต่ถ้าไม่ต้องการใช้ค่าใคค่าหนึ่ง เช่นใน function นี้ ถ้าเราไม่ต้องการเอาค่า bool ที่ function ส่งกลับมาใช้ สามารถใช้ `_` เพื่อไม่สนใจค่าเหล่านั้น

	v, _ := Mysquare(2.5)

หรือถ้า function นั้นไม่ส่งอะไรกลับมา (เป็น void นั้นเอง) ก็สามารถเรียก function นั้นได้เลย เช่น
